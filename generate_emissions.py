...
synch = ds.synch(nu, nu_synch * 1.e9, As, beta_s) * ds.dBrjdT(nu) # Synchrotron (include conversion from RJ to radiance)
...
plt.loglog(nu/1e9, synch, label='synch')
